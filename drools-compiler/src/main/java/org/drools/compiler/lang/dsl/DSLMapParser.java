// $ANTLR 3.5.2 src/main/resources/org/drools/compiler/lang/dsl/DSLMap.g 2017-07-17 18:12:49
...
public class DSLMapParser extends Parser {
	...
	public final DSLMapParser.entry_return entry() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: meta_section, value_section, key_section, scope_section
			// token labels: 
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
	...
	public final DSLMapParser.scope_section_return scope_section() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: value2, value3, value4, value1
			// token labels: 
	...
	public final DSLMapParser.variable_definition_return variable_definition() throws RecognitionException {
		...
		try {
			...
			// AST REWRITE
			// elements: name, q, name, name, name, name, name, q, q, name, q, q, q, name, q, q, q, name
			// token labels: q, name
			// rule labels: retval
			// token list labels: 
			// rule list labels: 
