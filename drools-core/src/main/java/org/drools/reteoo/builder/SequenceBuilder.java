...
import org.drools.reteoo.SequenceNode;
...
public class SequenceBuilder
    ...
    public void build(final BuildContext context,
        ...
        for( RuleConditionElement child : seq.getChildren() ) {
            ...
            // if object source is null, then we need to use tuple source
            if ( context.getObjectSource() == null ) {
                // attach sequence node
