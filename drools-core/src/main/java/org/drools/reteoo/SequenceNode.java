...
public class SequenceNode extends LeftTupleSource
    ...
    public void readExternal(ObjectInput in) throws IOException,
        ...
        sequence = (Sequence) in.readObject();
    }
...
//        }
    ...
    public void attach(BuildContext context) {
        ...
        this.tupleSource.addTupleSink( new SequenceSinkAdapter(this, 1 ), context );
        if ( context == null ) {
            return;
        }
...
//                               this.alphaConstraints );
    ...
    public static class SequenceSinkAdapter
            implements
            LeftTupleSink {
        private SequenceNode sink;
        private int          inputIndex;

        public SequenceSinkAdapter(SequenceNode sink,
                                   int inputIndex) {
            this.sink = sink;
        ...
        public void readExternal(ObjectInput in) throws IOException,
            ...
            sink = (SequenceNode) in.readObject();
        }
        ...
        public void remove(RuleRemovalContext context,
            ...
            sink.remove( context, builder, node, workingMemories );
        }

        public void addTupleSink(LeftTupleSink tupleSink) {
            sink.addTupleSink( tupleSink );
        }
        ...
        public void setPartitionId(RuleBasePartitionId partitionId) {
            sink.setPartitionId( partitionId );
        }

        public void addAssociation(Rule rule,
                                   RuleComponent component) {
            sink.addAssociation( rule, component );
        }
        ...
        public void removeAssociation(Rule rule) {
            sink.removeAssociation( rule );
        }

        public LeftTupleSinkPropagator getSinkPropagator() {
            return sink.getSinkPropagator();
        }
        ...
        public long getLeftDeclaredMask() {
            return sink.getLeftDeclaredMask();
        }

        public long getLeftInferredMask() {
            return sink.getLeftInferredMask();
        }

        public long getLeftNegativeMask() {
            return sink.getLeftNegativeMask();
        }

        public ObjectType getObjectType() {
            return sink.getObjectType();
        }
        ...
        public void networkUpdated(UpdateContext updateContext) {
            sink.networkUpdated( updateContext );
        }

        public void updateSink(LeftTupleSink sink,
                               PropagationContext context,
                               InternalWorkingMemory workingMemory) {
            this.sink.updateSink( sink, context, workingMemory );
        }

        public Memory createMemory(RuleBaseConfiguration config) {
            return sink.createMemory( config );
        }

        public LeftTupleSinkNode getNextLeftTupleSinkNode() {
            return sink.getNextLeftTupleSinkNode();
        }

        public void setNextLeftTupleSinkNode(LeftTupleSinkNode next) {
            sink.setNextLeftTupleSinkNode( next );
        }

        public LeftTupleSinkNode getPreviousLeftTupleSinkNode() {
            return sink.getPreviousLeftTupleSinkNode();
        }

        public void setPreviousLeftTupleSinkNode(LeftTupleSinkNode previous) {
            sink.setPreviousLeftTupleSinkNode( previous );
        }
        ...
        public boolean isLeftTupleMemoryEnabled() {
            return sink.isLeftTupleMemoryEnabled();
        }

        public void setLeftTupleMemoryEnabled(boolean tupleMemoryEnabled) {
            sink.setLeftTupleMemoryEnabled( tupleMemoryEnabled );
        ...
        public LeftTupleSource getLeftTupleSource() {
            return sink.getLeftTupleSource();
        }
        ...
        public LeftTuple createLeftTuple(InternalFactHandle factHandle,
                                         LeftTupleSink sink,
                                         boolean leftTupleMemoryEnabled) {
            return this.sink.createLeftTuple( factHandle, sink, leftTupleMemoryEnabled );
        }

        public LeftTuple createLeftTuple(LeftTuple leftTuple,
                                         LeftTupleSink sink,
                                         boolean leftTupleMemoryEnabled) {
            return this.sink.createLeftTuple( leftTuple, sink, leftTupleMemoryEnabled );
        }

        public LeftTuple createLeftTuple(LeftTuple leftTuple,
                                         RightTuple rightTuple,
                                         LeftTupleSink sink) {
            return this.sink.createLeftTuple( leftTuple, rightTuple, sink );
        }
        ...
        public LeftTuple createLeftTuple(LeftTuple leftTuple,
                                         ...
                                         LeftTupleSink sink,
                                         boolean leftTupleMemoryEnabled) {
            return this.sink.createLeftTuple( leftTuple, rightTuple, currentLeftChild, currentRightChild, sink, leftTupleMemoryEnabled );
        }

        public int getLeftInputOtnId() {
            return this.sink.getLeftInputOtnId();
        }

        public void setLeftInputOtnId(int leftInputOtnId) {
            this.sink.setLeftInputOtnId( leftInputOtnId );
        }
